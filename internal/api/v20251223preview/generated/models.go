...
type HcpOpenShiftClusterProperties struct {
	...
	// imageDigestMirrors is a set of rules to allow pulling images from a mirrored registry by using digest specifications. Changing
	// this value will trigger a rollout for all existing node pools in the
	// cluster.
