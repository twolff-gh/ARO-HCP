...
// newInsecureAzurePermissionsManagerIdentityTokenCredentialRetriever creates a new Azure Permissions Manager identity token credential retriever.
func newInsecureAzurePermissionsManagerIdentityTokenCredentialRetriever(ctx context.Context,
...
) (azureclient.InsecureARMPermissionsManagerIdentityTokenCredentialRetriever, error) {
	...
	retriever, err := azureclient.NewInsecureARMPermissionsManagerIdentityTokenCredentialRetriever(azureARMPermissionsManagerTenantID, azureARMPermissionsManagerClientID, certReader, azureConfig.CloudEnvironment.AZCoreClientOptions())
	if err != nil {
